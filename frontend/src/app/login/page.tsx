  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 pb-8">
      <div className="mb-8 text-center">
        <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center border-t-2 border-accent bg-navy text-chalk shadow-sm">
          <CircleDot className="h-8 w-8 text-accent" strokeWidth={2} />
        </div>
        <h1 className="font-display text-4xl text-primary">TenPulse</h1>
        <p className="mt-1 text-muted-foreground">Tenis tesisi operasyon yönetimi</p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder="demo@suncourtstennis.com"
                value={email}
