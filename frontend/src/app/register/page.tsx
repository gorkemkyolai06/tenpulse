  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 py-8">
      <div className="mb-6 text-center">
        <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center border-t-2 border-accent bg-navy text-chalk shadow-sm">
          <CircleDot className="h-7 w-7 text-accent" strokeWidth={2} />
        </div>
        <h1 className="font-display text-3xl text-primary">Kulüp Kaydı</h1>
      </div>

      <Card className="clay-card w-full max-w-lg">
        <CardHeader>
          <CardTitle className="font-display text-2xl">Yeni Tenis Kulübü Oluştur</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="tennisClubName">Kulüp Adı</Label>
              <Input
                id="tennisClubName"
                value={form.tennisClubName}
                onChange={(e) => update('tennisClubName', e.target.value)}
                required
                placeholder="Sun Courts Tennis Club"
              />
            </div>
            <div className="space-y-2">
            ...
            <Button type="submit" className="clay-btn w-full" disabled={loading}>
